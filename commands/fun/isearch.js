module.exports = {
    ...
    execute(message, args, Client, Discord) {
        ...
        function image(message) {
            ...
            var options = {
                url: "http://results.dogpile.com/serp?qc=images&q=" + `${searchq}`,
                method: "GET",
                headers: {
                    "Accept": "text/html",
                    "User-Agent": "Chrome"
            ...
            request(options, function (error, response, responseBody) {
                ...
                if (!urls.length) {
                    const no_urls = new Discord.MessageEmbed()
                        .setTitle(`I can\'t find ${searchq}`)
                        .setColor(`0xFF0000`)
                        .setThumbnail(`https://raw.githubusercontent.com/Joshua-Noakes1/Lake-CDN/master/CDN/Images/Errors/error_1_red.png`)
                        .setDescription(`I can\'t find any images for ${searchq}\nTry and search again...`)
                        .setTimestamp();
